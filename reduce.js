...
function extractValue(arr, key) {
    // return reduce, callback(accumulator, nextValue)
    return arr.reduce(function(accumulator, nextValue) {
        // push nextValue[key] -> 'name'
        accumulator.push(nextValue[key]); 
        // return accumulator 
        return accumulator;  
    // pass [] as initial value so we can push
    }, []); 
}
